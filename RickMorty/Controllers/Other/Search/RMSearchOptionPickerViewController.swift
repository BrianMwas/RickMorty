...
//  RickMorty
//
//  Created by Brian on 20/04/2023.
//

import UIKit

final class RMSearchOptionPickerViewController: UIViewController {
    private let option: RMSearchBarViewViewModel.DynamicOption
    ...
    // MARK: - Init
    init(option: RMSearchBarViewViewModel.DynamicOption, selection: @escaping (String) -> Void) {
        self.option = option
